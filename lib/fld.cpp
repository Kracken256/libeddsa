...
namespace def::eddsa
{
	...
	fld_mul(fld_t res, const fld_t a, const fld_t b)
	{
		...
		c[0] = (llimb_t)a[0] * b[0] + (llimb_t)a19_1 * b[4] + (llimb_t)a19_2 * b[3] + (llimb_t)a19_3 * b[2] + (llimb_t)a19_4 * b[1];
		c[1] = (llimb_t)a[0] * b[1] + (llimb_t)a[1] * b[0] + (llimb_t)a19_2 * b[4] + (llimb_t)a19_3 * b[3] + (llimb_t)a19_4 * b[2];
		c[2] = (llimb_t)a[0] * b[2] + (llimb_t)a[1] * b[1] + (llimb_t)a[2] * b[0] + (llimb_t)a19_3 * b[4] + (llimb_t)a19_4 * b[3];
		c[3] = (llimb_t)a[0] * b[3] + (llimb_t)a[1] * b[2] + (llimb_t)a[2] * b[1] + (llimb_t)a[3] * b[0] + (llimb_t)a19_4 * b[4];
		c[4] = (llimb_t)a[0] * b[4] + (llimb_t)a[1] * b[3] + (llimb_t)a[2] * b[2] + (llimb_t)a[3] * b[1] + (llimb_t)a[4] * b[0];
...
#define CARRY(dst, src, tmp, off)                                 \
	...
	fld_mul(fld_t dst, const fld_t a, const fld_t b)
	{
		...
		c[3] = (llimb_t)a[0] * b[3] + (llimb_t)a[1] * b[2] + (llimb_t)a[2] * b[1] + (llimb_t)a[3] * b[0];
		c[4] = (llimb_t)a[0] * b[4] + (llimb_t)2 * a[1] * b[3] + (llimb_t)a[2] * b[2] + (llimb_t)2 * a[3] * b[1] + (llimb_t)a[4] * b[0];
		c[5] = (llimb_t)a[0] * b[5] + (llimb_t)a[1] * b[4] + (llimb_t)a[2] * b[3] + (llimb_t)a[3] * b[2] + (llimb_t)a[4] * b[1] + (llimb_t)a[5] * b[0];
		c[6] = (llimb_t)a[0] * b[6] + (llimb_t)2 * a[1] * b[5] + (llimb_t)a[2] * b[4] + (llimb_t)2 * a[3] * b[3] + (llimb_t)a[4] * b[2] + (llimb_t)2 * a[5] * b[1] + (llimb_t)a[6] * b[0];
		c[7] = (llimb_t)a[0] * b[7] + (llimb_t)a[1] * b[6] + (llimb_t)a[2] * b[5] + (llimb_t)a[3] * b[4] + (llimb_t)a[4] * b[3] + (llimb_t)a[5] * b[2] + (llimb_t)a[6] * b[1] + (llimb_t)a[7] * b[0];
		c[8] = (llimb_t)a[0] * b[8] + (llimb_t)2 * a[1] * b[7] + (llimb_t)a[2] * b[6] + (llimb_t)2 * a[3] * b[5] + (llimb_t)a[4] * b[4] + (llimb_t)2 * a[5] * b[3] + (llimb_t)a[6] * b[2] + (llimb_t)2 * a[7] * b[1] + (llimb_t)a[8] * b[0];
		c[9] = (llimb_t)a[0] * b[9] + (llimb_t)a[1] * b[8] + (llimb_t)a[2] * b[7] + (llimb_t)a[3] * b[6] + (llimb_t)a[4] * b[5] + (llimb_t)a[5] * b[4] + (llimb_t)a[6] * b[3] + (llimb_t)a[7] * b[2] + (llimb_t)a[8] * b[1] + (llimb_t)a[9] * b[0];

		c[0] += 19 * ((llimb_t)2 * a[1] * b[9] + (llimb_t)a[2] * b[8] + (llimb_t)2 * a[3] * b[7] + (llimb_t)a[4] * b[6] + (llimb_t)2 * a[5] * b[5] + (llimb_t)a[6] * b[4] + (llimb_t)2 * a[7] * b[3] + (llimb_t)a[8] * b[2] + (llimb_t)2 * a[9] * b[1]);
		c[1] += 19 * ((llimb_t)a[2] * b[9] + (llimb_t)a[3] * b[8] + (llimb_t)a[4] * b[7] + (llimb_t)a[5] * b[6] + (llimb_t)a[6] * b[5] + (llimb_t)a[7] * b[4] + (llimb_t)a[8] * b[3] + (llimb_t)a[9] * b[2]);
		c[2] += 19 * ((llimb_t)2 * a[3] * b[9] + (llimb_t)a[4] * b[8] + (llimb_t)2 * a[5] * b[7] + (llimb_t)a[6] * b[6] + (llimb_t)2 * a[7] * b[5] + (llimb_t)a[8] * b[4] + (llimb_t)2 * a[9] * b[3]);
		c[3] += 19 * ((llimb_t)a[4] * b[9] + (llimb_t)a[5] * b[8] + (llimb_t)a[6] * b[7] + (llimb_t)a[7] * b[6] + (llimb_t)a[8] * b[5] + (llimb_t)a[9] * b[4]);
		c[4] += 19 * ((llimb_t)2 * a[5] * b[9] + (llimb_t)a[6] * b[8] + (llimb_t)2 * a[7] * b[7] + (llimb_t)a[8] * b[6] + (llimb_t)2 * a[9] * b[5]);
		c[5] += 19 * ((llimb_t)a[6] * b[9] + (llimb_t)a[7] * b[8] + (llimb_t)a[8] * b[7] + (llimb_t)a[9] * b[6]);
